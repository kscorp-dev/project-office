# Project Office v0.23.2

사내 업무 통합 플랫폼 - 전자결재, 메신저, CCTV, 근태관리, 작업지시서 외 12개 모듈

> **Production**: [https://43-200-29-148.sslip.io](https://43-200-29-148.sslip.io)
> **2차 종합 감사 + 추가 결함 13종 수정** — WebSocket 룸 검증 / 결재 위임 권한 일관 / refresh race / decline 인증<br/>
> **3차 검증 결과: Critical 0, High 0** ✅
...
```bash
# Backend (313 유닛/통합 테스트 — 일부 통합 테스트는 PostgreSQL 필요)
cd apps/backend
npm test                    # 전체 실행
