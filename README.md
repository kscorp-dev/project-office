# Project Office v0.23.3

사내 업무 통합 플랫폼 - 전자결재, 메신저, CCTV, 근태관리, 작업지시서 외 12개 모듈

> **Production**: [https://43-200-29-148.sslip.io](https://43-200-29-148.sslip.io)
> **4차/5차/6차 종합 감사 — Mass Assignment 방어 + Rate Limit + 추가 sensitive 화면**<br/>
> **6차 최종 검증: Critical 0, High 0** ✅ (1차~6차 누적 28건 결함 모두 수정)
...
```bash
# Backend (317 유닛/통합 테스트 — 일부 통합 테스트는 PostgreSQL 필요)
cd apps/backend
npm test                    # 전체 실행
